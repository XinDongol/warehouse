...
#                    num_images, batch_size))
        ...
        self.queue_runner = tf.train.QueueRunner(queue=processed_queue,
                                                 enqueue_ops=[enqueue_processed_op] * num_concurrent)
    ...
    def start(self, session, coordinator, num_concurrent=4):
        ...
        print('path_queue_num:', session.run(self.path_queue.size()))
    ...
    def get(self, session):
        ...
        '''
        plt.imshow(session.run(self.processed_image))
    ...
    def load_image(self, image_path, is_jpeg):
        ...
        if self.data_spec.expects_bgr:
            ...
            # here we upgrade original code(TF0.10) to TF 1.0
